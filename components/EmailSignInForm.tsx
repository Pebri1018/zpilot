  ...
  return (
    <form onSubmit={signIn} className="space-y-4">
      ...
      <div className="text-center mb-4">
        <p className="text-[0.85rem] text-neutral-500 font-medium">Sistem pintar (Tanpa Password). Masukkan email untuk Daftar akun baru atau Masuk ke akun lama.</p>
      </div>
      ...
      <div className="relative flex items-center py-4">
        ...
        <span className="flex-shrink-0 mx-4 text-neutral-400 text-sm font-medium">Atau</span>
        <div className="flex-grow border-t border-neutral-200"></div>
      </div>
      ...
      <button
        ...
        disabled={disabled}
        className="flex w-full items-center justify-center gap-3 rounded-2xl bg-white border-2 border-neutral-100 py-4 text-[1.05rem] font-semibold text-neutral-700 shadow-[0_2px_10px_rgba(0,0,0,0.02)] transition enabled:active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-50 hover:bg-neutral-50"
      >
