...
export function AkunClient({ email, nama, kota, platform, driverId, zpilotId, role, feedback = [] }: Props) {
  ...
  const profileItems = [
    ...
    { label: "Platform", value: platform || "ShopeeFood" },
            ...
            {modal === "profile" && (
              <form action={async (fd) => {
                ...
                <div className="space-y-3">
                  ...
                  <select name="platform" defaultValue={platform || "ShopeeFood"} className="w-full px-4 py-3 rounded-2xl bg-neutral-50 dark:bg-neutral-700 border border-neutral-200 dark:border-neutral-600 text-[0.9rem] dark:text-white focus:outline-none focus:border-neutral-400 dark:focus:border-neutral-500" required>
